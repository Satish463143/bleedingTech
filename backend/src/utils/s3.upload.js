 ...
 */
async function uploadToS3({ s3, Bucket, Key, Body, ContentType, CacheControl, ACL }) {
  const uploader = new Upload({
    ...
    params: {
      ...
      Body,
      ContentType,
      CacheControl,   // e.g. 'public, max-age=31536000'
      ACL,            // e.g. 'public-read' (only if you actually want public objects)
    },
    queueSize: 4,
