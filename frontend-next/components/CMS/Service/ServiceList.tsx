...
import { useListAllQuery, useDeleteServicesMutation } from '../../api/services.api';
    ...
    const handleSearchChange = (event: React.ChangeEvent<HTMLInputElement>) => {
      ...
      const deleteData=async(id:string)=>{
        try{
          ...
          toast.error("Cannot delete service at this moment")
        }    
      }
  return (
    <div className='admin_margin_box'>
      <div className='admin_titles'>
        <AdminTitle url='/admin/service' label1=' Service List' label2='' />
        ...
        <table border={2}>
          ...
          <tbody>
            {isLoading ? (
              ...
              service.map((row: any, index: number) => (
                <tr key={index}>
