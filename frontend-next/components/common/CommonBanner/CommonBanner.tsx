...
import { motion,type Variants , useAnimation, useScroll, useTransform } from "framer-motion";
    ...
    >
      ...
      >
        <motion.div
          ...
          animate={{ scale: [1, 1.15, 1], opacity: [0.3, 0.5, 0.3], rotate: [0, 5, 0] }}
          transition={{ duration: 12, repeat: Infinity, ease: "easeInOut" }}
          style={{
            background: "radial-gradient(ellipse, hsl(var(--primary) / 0.2), transparent 60%)",
            filter: "blur(100px)",
          }}
        />
        ...
        <motion.div
          ...
          animate={{ y: [-15, 15, -15], rotate: [0, 180, 360], scale: [1, 1.1, 1] }}
          transition={{ duration: 12, repeat: Infinity, ease: "easeInOut" }}
        >
        ...
        {/* NOTE: kept your particles logic as-is (random on render). */}
        {[...Array(12)].map((_, i) => (
          <motion.div
            key={i}
            ...
            animate={{ opacity: [0.1, 0.6, 0.1], scale: [1, 1.5, 1], y: [0, -30, 0] }}
            transition={{
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none">
        <svg className="relative block w-full h-16 lg:h-24" viewBox="0 0 1200 120" preserveAspectRatio="none">
          <defs>
      ...
      <motion.div
        ...
        transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
      >
        <div className="w-full h-full border-2 rounded-lg" style={{ borderColor: "hsl(var(--primary))" }} />
      </motion.div>
