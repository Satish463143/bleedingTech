...
const ContactCTA: React.FC<ContactCTAProps> = ({
  ...
  desc = "Let's discuss your project and create something extraordinary together. Our team is ready to bring your vision to life.",
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(180deg, hsl(var(--bg-foreground) / 0.05) 0%, hsl(var(--background)) 50%, hsl(var(--bg-foreground) / 0.08) 100%)",
      }}
    >
      {/* Animated Background */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        >
          <MessageCircle className="w-14 h-14" style={{ color: "hsl(var(--primary-accent))" }} />
        </motion.div>
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        >
          ...
          {/* Description */}
          <motion.p
            className="text-lg lg:text-xl mb-10 max-w-2xl mx-auto leading-relaxed"
