...
export default function FAQItem({ faq, index, isActive, onToggle }: Props) {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={{ y: isHovered && !isActive ? -4 : 0 }}
      ...
      >
        <motion.div
          ...
          animate={{ opacity: isActive ? 0.25 : isHovered ? 0.1 : 0 }}
          transition={{ duration: 0.3 }}
        />
        ...
        <motion.div
          ...
          animate={{ opacity: isActive ? 1 : isHovered ? 0.5 : 0.2 }}
          transition={{ duration: 0.3 }}
        />
