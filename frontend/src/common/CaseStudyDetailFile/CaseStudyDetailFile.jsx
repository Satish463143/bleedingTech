...
export const HeroImage = ({ study }) => {
  ...
  // Project Info Bar
  export const ProjectInfo = ({ study }) => {
    const infoItems = [
  ...
  // Overview Section
  export const OverviewSection = ({ study }) => {
  ...
  export const ChallengeSolution = ({ study }) => {
    const controls = useAnimation();
  ...
  // Results Section
  export const ResultsSection = ({ study }) => {
    const controls = useAnimation();
    const [ref, inView] = useInView({ threshold: 0.2, triggerOnce: true });
  ...
  export const TechSection = ({ study }) => {
    const controls = useAnimation();
    const [ref, inView] = useInView({ threshold: 0.2, triggerOnce: true });
  ...
  // Testimonial Section
  export const TestimonialSection = ({ study }) => {
    const controls = useAnimation();
    const [ref, inView] = useInView({ threshold: 0.2, triggerOnce: true });
