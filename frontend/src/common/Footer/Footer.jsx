...
const Footer = () => {
  ...
  return (
    <footer className="relative overflow-hidden pb-20 lg:pb-6">
      {/* UNIQUE BACKGROUND - Aurora/Mesh Gradient Effect */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        >
          <motion.path
            ...
            initial={{ d: "M0,50 C360,100 720,0 1080,50 C1260,75 1350,25 1440,50 L1440,0 L0,0 Z" }}
            animate={{
              d: [
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10 pt-20">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-4 mb-8">
              <ContactItem
                icon={Mail}
                text="support@bleedingtech.com"
                href="mailto:support@bleedingtech.com"
              />
              <ContactItem
                icon={Phone}
                text="+977-98XXXXXXXX"
        ...
        >
          ...
          >
            © 2025{" "}
            <span style={{ color: "hsl(var(--primary))" }}>Bleeding Tech</span>.
            All Rights Reserved.
          </p>
...
const SocialIcon = ({ icon: Icon, href, color, name }) => {
  const [isHovered, setIsHovered] = useState(false);
